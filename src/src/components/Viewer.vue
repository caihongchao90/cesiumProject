<template>
  ...
  <button @click="removeCoordinate()"
    style="width: 120px;height: 40px; position: absolute;top:180px;left: 50px">取消编辑</button>
  <!--    <div id="fpslabel"></div>-->
</template>
