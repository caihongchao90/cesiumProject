 import "./style.css"
 export default class PopupWindow1 {
     ...
     createDom() {
         ...
         this.container.innerHTML =
             `  <div class="popup3d1-container" v-if="show">
     ...
     //点击关闭
     initEvent() {
         this.container.getElementsByClassName("popup3d1-close")[0]
             .onclick = e => {
                 this.close();
             }
     }
     ...
     postRender() {
         ...
         this.container.style.left = windowPosition.x - (340 / 2) + "px";
