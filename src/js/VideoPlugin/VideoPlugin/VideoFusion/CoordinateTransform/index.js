var CoordinateTransform = function() {
...
CoordinateTransform.prototype.CalculateCoordinates = function(point, azimuth, elevation, distance) {
 ...
 *@lonLat 经纬度
 */
CoordinateTransform.prototype.lonLat2WebMercator = function(lonLat) {
 ...
 *@mercator 平面坐标
 */
CoordinateTransform.prototype.webMercator2LonLat = function(mercator) {
...
CoordinateTransform.prototype.get_atan = function(z, y) {
    let x;
    if (z == 0) {
        x = this.PI / 2;
    } else {
...
//WGS84转ECEF坐标系
CoordinateTransform.prototype.ConvertLLAToXYZ = function(LLACoor) {
...
//ECEF坐标系转WGS84
CoordinateTransform.prototype.ConvertXYZToLLA = function(XYZCoor) {
...
CoordinateTransform.prototype.enu_to_ecef = function(a, p) {
    //距离
...
CoordinateTransform.prototype.radians = function(degree) {
